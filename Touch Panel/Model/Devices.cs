...
namespace Touch_Panel.Model
{
    ...
    public partial class Devices : ObservableObject
    {
        ...
        public string BuildTspl(string partNumber, string date, string serial, string qrString)
        {
            ...
            // Khi đủ 3 bước MEAS (data dài, ~V8/49 module) -> cell 3 ≈ 147 dots / 236.
            ...
            // =========================
            // TEXT FIELDS
            // "HUMAN THAI" xoay dọc 270° nằm bên TRÁI (đọc từ dưới lên), canh giữa chiều cao.
